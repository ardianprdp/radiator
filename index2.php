      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="col-sm-12 input-group">
            ...
            <input id="firefox" type="text" class="form-control" readonly="readonly" value="localhost, 127.0.0.1, 10.0.0.0/8, naskpp, bospn, spnapp1, sidjp, sidjp5, sidjp7, sidjp9, sidjp10, appportal, sidjpwf, amnesti-pajak, elearning-djp, emaildjp, djponline, efiling, dmsviewerdjp, notifikasidatantpn, ereg, ereg2, helpmi, tpt-SIDJP NINE, alket, aktivasiefin, sapujagat, rekamspt, kepegawaian-djp, sikka-djp, sikeu-djp, eregkpp, eregkpp2, e-nofa, persil, billing-djp, billing-batch, monitoringspt, kompatriot, monitoring, portaldjp, p2humas, opdp, todolist-oc, dropbox, dropbox1, dropbox2, dropbox3, dropbox4, dropbox5, ras-sidjp, lasisonline, dashboard, rikpen, tkb-djp, kitsda, transformasi-kelembagaan, wwwsiptb, penyuluhan, pendukung-upddp, bimsis, ebimtek, pengaudanpajak, .kpp, approweb.intranet.pajak.go.id, mandor-djp, sso.SIDJP NINE.intranet.pajak.go.id">
          </div>
        </div>
