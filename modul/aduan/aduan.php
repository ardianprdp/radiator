      ...
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php inputAduan() ;?>">
              <div class="card-body">
                    ...
                    <tr>
                      ...
                      <td class="text-right py-0 align-middle">
                        <div class="btn-group btn-group-sm">
                          <?php if ($a['status'] == "open" || $a['status'] == "selesai") {
                            echo '<a href="proses-aduan.php?id=' . $a['id'] . '" class="btn btn-info"><i class="fas fa-eye"></i></a>';
                          } ?>
                          <?php if ($a['status'] == "open") {
                            echo '<a href="hapus-aduan.php?id=' . $a['id'] . '" onclick="return checkDelete()" class="btn btn-danger" )><i class="fas fa-trash"></i></a>';
                          } ?>
                        </div>
                      </td>
                    </tr>
